...
The problem is discussed also in the section about Risk profiles (**REVISIT FOR CROSS REFERENCE**) which discusses why you should not split the hazard 
calculation in different countries when running a continental scale calculation.